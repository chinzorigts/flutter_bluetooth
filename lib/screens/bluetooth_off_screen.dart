...
import 'package:flutter_bluetooth/screens/widgets/app_loader.dart';
            ...
            if(snapshot.hasData){
              return SafeArea(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Lottie.asset('assets/lotties/turn_on_bluetooth.json',
                        repeat: true,
                        animate: true,
                        fit: BoxFit.fill
                    ),
                    ...
                    InfoRow(name: "Platform is ",value: Platform.isAndroid ? 'Android Device Info'
                        : Platform.isIOS ? 'iOS Device Info' : Platform.isMacOS ? 'MacOS Device Info' : Platform.isWindows ? 'Windows Device Info' : 'Unknown'),

                    InfoRow(name: 'Application name', value: _packageInfo.appName.toUpperCase()),
                    InfoRow(name: 'Build number', value: _packageInfo.buildNumber.toUpperCase()),
...
class InfoRow extends StatelessWidget{
  ...
  const InfoRow({Key? key,required this.name,required this.value}) : super(key: key);
